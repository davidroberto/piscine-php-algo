...
function substractNumbers($number1, $number2) {
	echo "<p>le résultat de la soustraction est : " . $number1 - $number2 . "</p>";
}
...
function divibeBy2($number1) {
	echo "<p>le résultat de la division par deux est : " . $number1 / 2 . "</p>";
}
...
function calculateSquareRoot($number1) {
	echo "<p>le résultat de la racine carrée est : " . sqrt($number1) . "</p>";
}
